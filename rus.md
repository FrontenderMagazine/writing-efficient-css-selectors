...
селектор -- добавив класс .social-link к каждому из элементов <a> в
области #social. Но это идет против того, что нам известно: мы ведь знаем, что
не нужно добавлять лишние классы к элементам, когда мы можем использовать более
чистую разметку с меньшим количеством кода.
