...
DOM-элементов. Но, в конце концов, лучшая практика - есть лучшая практика, и не
имеет значения: разрабатываете ли вы второй Facebook или сайт для местного
...
> Важно отметить, хотя ID технически быстрее, с точки зрения
производительности, разница очень невелика. С помощью CSS Test Creator Стива
Саудерса можно видеть, что у [селекторов по ID][2] и [селекторов по классу][3],
...
так что, в дейтвительности, с ID страница перерисовывалась медленнее, чем с
классом.
